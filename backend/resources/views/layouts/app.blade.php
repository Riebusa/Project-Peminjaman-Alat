    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gray-900 text-white flex flex-col hidden md:flex">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="{{ route('admin.user.index') }}" class="block px-4 py-2 rounded-lg text-gray-400 hover:bg-gray-800 text-white transition">Kelola User</a>
                ...
                <a href="{{ route('admin.alat.index') }}" class="block px-4 py-2 rounded-lg text-gray-400 hover:bg-gray-800 text-white transition">Kelola Alat</a>
